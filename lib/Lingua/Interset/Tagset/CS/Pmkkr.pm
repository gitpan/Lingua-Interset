...
use strict;
use warnings;
our $VERSION = '2.023'; # VERSION: generated by DZP::OurPkgVersion
...
Lingua::Interset::Tagset::CS::Pmkkr - Driver for the shortened Czech tagset of the Prague Spoken Corpus (Prazsky mluveny korpus).
