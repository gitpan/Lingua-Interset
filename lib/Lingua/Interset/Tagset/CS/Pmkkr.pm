...
use strict;
use warnings;
our $VERSION = '2.006'; # VERSION: generated by DZP::OurPkgVersion
...
Lingua::Interset::Tagset::CS::Pmkkr - Driver for the shortened Czech tagset of the Prague Spoken Corpus (PraÅ¾skÃ½ mluvenÃ½ korpus).
