...
use strict;
use warnings;
our $VERSION = '2.019'; # VERSION: generated by DZP::OurPkgVersion
...
Lingua::Interset::Tagset::PT::Cintil - Driver for the Portuguese tagset of the CINTIL corpus (Corpus Internacional do Portugu&ecir;s).
